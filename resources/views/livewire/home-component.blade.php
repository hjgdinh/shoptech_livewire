                        ...
                        <div class="col-lg-7 col-md-6">
                            <div class="single-slider-img single-slider-img-1">
                                <img class="animated slider-1-1"
                                    src="{{ asset('assets/imgs/slider/slider-1') }}.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-7 col-md-6">
                            <div class="single-slider-img single-slider-img-1">
                                <img class="animated slider-1-2"
                                    src="{{ asset('assets/imgs/slider/slider-2') }}.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                ...
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('assets/imgs/shop/product-1') }}-2.jpg"
                                                alt="">
                                        </a>
                                    </div>
                                    ...
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                ...
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('assets/imgs/shop/product-3') }}-2.jpg"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-xs-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('assets/imgs/shop/product-5') }}-1.jpg"
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('assets/imgs/shop/product-5') }}-2.jpg"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-xs-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('assets/imgs/shop/product-6') }}-1.jpg"
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('assets/imgs/shop/product-6') }}-2.jpg"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-xs-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('assets/imgs/shop/product-7') }}-1.jpg"
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('assets/imgs/shop/product-7') }}-2.jpg"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('assets/imgs/shop/product-8') }}-1.jpg"
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('assets/imgs/shop/product-8') }}-2.jpg"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('assets/imgs/shop/product-9') }}-1.jpg"
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('assets/imgs/shop/product-9') }}-2.jpg"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('assets/imgs/shop/product-10') }}-1.jpg"
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('assets/imgs/shop/product-10') }}-2.jpg"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('assets/imgs/shop/product-11') }}-1.jpg"
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('assets/imgs/shop/product-11') }}-2.jpg"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('assets/imgs/shop/product-12') }}-1.jpg"
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('assets/imgs/shop/product-12') }}-2.jpg"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('assets/imgs/shop/product-13') }}-1.jpg"
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('assets/imgs/shop/product-13') }}-2.jpg"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('assets/imgs/shop/product-14') }}-1.jpg"
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('assets/imgs/shop/product-14') }}-2.jpg"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('assets/imgs/shop/product-15') }}-1.jpg"
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('assets/imgs/shop/product-15') }}-2.jpg"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                ...
                <div class="carausel-6-columns" id="carausel-6-columns">
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop.html"><img src="{{ asset('assets/imgs/shop/category-thumb') }}-1.jpg"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop.html"> <img
                                    src="{{ asset('assets/imgs/shop/category-thumb') }}-2.jpg"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop.html"><img src="{{ asset('assets/imgs/shop/category-thumb') }}-3.jpg"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop.html"><img src="{{ asset('assets/imgs/shop/category-thumb') }}-4.jpg"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop.html"><img src="{{ asset('assets/imgs/shop/category-thumb') }}-5.jpg"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop.html"><img src="{{ asset('assets/imgs/shop/category-thumb') }}-6.jpg"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop.html"><img src="{{ asset('assets/imgs/shop/category-thumb') }}-7.jpg"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop.html"><img src="{{ asset('assets/imgs/shop/category-thumb') }}-8.jpg"
                                    alt=""></a>
                        </figure>
                        ...
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="product-details.html">
                                    ...
                                    <img class="hover-img"
                                        src="{{ asset('assets/imgs/shop/product-4') }}-2.jpg" alt="">
                                </a>
                            </div>
                            <div class="product-action-1">
                                <a aria-label="Quick view" class="action-btn small hover-up"
                        ...
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="product-details.html">
                                    ...
                                    <img class="hover-img"
                                        src="{{ asset('assets/imgs/shop/product-15') }}-2.jpg" alt="">
                                </a>
                            </div>
                            <div class="product-action-1">
                                <a aria-label="Quick view" class="action-btn small hover-up"
                        ...
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="product-details.html">
                                    ...
                                    <img class="hover-img"
                                        src="{{ asset('assets/imgs/shop/product-3') }}-2.jpg" alt="">
                                </a>
                            </div>
                            <div class="product-action-1">
                                <a aria-label="Quick view" class="action-btn small hover-up"
                        ...
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="product-details.html">
                                    ...
                                    <img class="hover-img"
                                        src="{{ asset('assets/imgs/shop/product-7') }}-2.jpg" alt="">
                                </a>
                            </div>
                            <div class="product-action-1">
                                <a aria-label="Quick view" class="action-btn small hover-up"
