                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <form method="post">
                                ...
                                <div class="form-group">
                                    <input type="text" wire:model="s_address" placeholder="Address line2">
                                    @error('s_address')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    <input required="" type="text" wire:model="country"
                                ...
                                <div class="form-group">
                                    <input required="" type="text" wire:model="zipcode"
                                ...
                                <div class="form-group">
                                    <input required="" type="text" wire:model="email"
                        ...
                        <div class="col-md-6">
                            <div class="order_review">
                                ...
                                <div class="table-responsive order_table text-center">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>SubTotal</th>
                                                <td class="product-subtotal" colspan="2">{{ Cart::subtotal() }} VND
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Shipping</th>
                                    ...
                                    <div class="payment_option">
                                        <div class="custome-radio">
                                            <input class="form-check-input" required type="radio" value="1"
                                                id="exampleRadios3" wire:model="payment_method">
                                        ...
                                        <div class="custome-radio">
                                            <input class="form-check-input" required type="radio"
                                                id="exampleRadios4" wire:model="payment_method" value="2">
                                            <label class="form-check-label" for="exampleRadios4"
                                                data-bs-toggle="collapse" data-target="#cardPayment"
                                                aria-controls="cardPayment">Trả qua Card / Visa</label>
                                        </div>
                                        <div class="custome-radio">
                                            <input class="form-check-input" required type="radio" value="3"
                                                id="exampleRadios5" wire:model="payment_method">
                                ...
                                <button type="submit" wire:click.prevent="placeOrder"
